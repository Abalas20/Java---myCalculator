...
public class Calculator extends JPanel {
	...
	private ArrayList<String> specialOperatorArray = new ArrayList<>();
    ...
    class ButtonActionListener implements ActionListener{
	    ...
	    public void IntegerInput(String integer){
	        /**
	         * This method checks if there is a single zero in the input string, if so it will be replaced by an integer
